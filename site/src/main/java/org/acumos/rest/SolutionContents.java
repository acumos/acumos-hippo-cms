...
public class SolutionContents extends BaseRestResource {
	...
	public SolutionDescriptionContent createSolDescription(@Context HttpServletRequest request,
		...
		return createSolDescription(workspace, description, requestContext);

	}

	public SolutionDescriptionContent createSolDescription(String workspace, SolutionDescriptionContent description,
